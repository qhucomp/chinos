...
void spi_init(spi_device_num_t spi_num, spi_work_mode_t work_mode,
              spi_frame_format_t frame_format, size_t data_bit_length,
              uint32_t endian);
 ...
 *
 */
void spi_init_non_standard(
    spi_device_num_t spi_num, uint32_t instruction_length,
 ...
 *     - Other  Fail
 */
void spi_receive_data_multiple(spi_device_num_t spi_num,
                               spi_chip_select_t chip_select,
 ...
 *     - Other  Fail
 */
void spi_send_data_multiple(spi_device_num_t spi_num,
                            spi_chip_select_t chip_select,
                            const uint32_t *cmd_buff, size_t cmd_len,
                            const uint8_t *tx_buff, size_t tx_len);
...
void spi_slave_config(uint8_t int_pin, uint8_t ready_pin,
                      //dmac_channel_number_t dmac_channel,
                      size_t data_bit_length, uint8_t *data, uint32_t len,
                      spi_slave_receive_callback_t callback);
