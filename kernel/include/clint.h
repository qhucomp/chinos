 ...
 *              holds its coreâ€™s time comparator. A timer interrupt is pending
 *              whenever mtime is greater than or equal to the value in a
 *              coreâ€™s mtimecmp register. The timer interrupt is reflected in
 *              the mtip bit of the associated coreâ€™s mip register.
 */
...
uintptr_t handle_irq_m_timer(void);
#endif